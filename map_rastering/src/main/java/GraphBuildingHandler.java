...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private List<Long> possibleVertices = new ArrayList<>();
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            possibleVertices.add(Long.parseLong(attributes.getValue("ref")));
...
//            System.out.println("Node's name: " + attributes.getValue("v"));
    ...
    public void endElement(String uri, String localName, String qName) throws SAXException {
        if (qName.equals("way")) {
            ...
            for (int i = 0; i < possibleVertices.size() - 1; i += 1) {
                g.addEdge(possibleVertices.get(i), possibleVertices.get(i + 1));
            }
            possibleVertices.clear();
            flag = false;
        }
